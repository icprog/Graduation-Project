...
int id3_tag_attachframe(struct id3_tag *tag, struct id3_frame *frame)
{
  ...
  frames = aw_mem_realloc(tag->frames, (tag->nframes + 1) * sizeof(*frames));
  if (frames == 0)
    return -1;
